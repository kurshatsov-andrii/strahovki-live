  ...
  return (
    <section id="calculator" className="bg-secondary/50 py-16 sm:py-20">
      <div className="container-page">
        ...
        <div className="mx-auto mt-12 grid max-w-5xl grid-cols-[minmax(0,1fr)] gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
          <form
            ...
            {isTravel && tooOld && (
              <div className="mt-4 rounded-xl border border-primary/30 bg-primary/5 p-4 text-sm">
                ...
                <p className="mt-1 text-muted-foreground">
                  Для мандрівників старше 70 років вартість визначається індивідуально андерайтером, франшиза 150 €, максимальний термін — 14 днів. Напишіть особисто — підберемо умови вручну.
                </p>
...
function LeadDialog({
  ...
  const isTravelLead = product === "travel";
            ...
            const parsed = isSport
              ...
              : isGreenCard
                ...
                : isAutoLead
                  ...
                  : isTravelLead
                    ? travelLeadSchema.safeParse(raw)
              ...
              <p className="rounded-xl bg-secondary/60 p-3 text-sm text-muted-foreground">
                {isSport
                  ...
                  : isAutoLead
                    ...
                    : isTravelLead
                      ? "Для оформлення туристичного полісу заповніть дані застрахованого. Посилання на оплату надішлемо у Viber."
